...
def seed_articles():
    ...
    test2 = Article(
        user_id=2, title='New York, New York', description='https://en.wikipedia.org/wiki/New_York_City',article="The English took over the colony in 1664 during the second Anglo-Dutch War. They changed the name to New York, to honor the Duke of York, who later became King James II of England. The Dutch surrendered Nieuw Amsterdam without fighting.")
    test3 = Article(
        user_id=3, title='Boiling Point', description='http://en.m.wikipedia.org/wiki/Fahrenheit',article="On the Fahrenheit scale, the freezing point of water is 32 degrees Fahrenheit (°F) and the boiling point 212 °F (at standard atmospheric pressure). This puts the boiling and freezing points of water exactly 180 degrees apart.")
    test4 = Article(
        user_id=4, title='Water Weight', description='http://water.usgs.gov/edu/propertyyou.html',article="By one year of age, that amount drops to about 65%. In adult men, about 60 percent of their bodies are water. However, fat tissue does not have as much water as lean tissue. In adult women, fat makes up more of the body than men, so they have about 55 percent of their bodies made of water.")
    test5 = Article(
        user_id=5, title='Bean Water', description='http://en.wikipedia.org/wiki/Coffee',article="It was here in Arabia that coffee seeds were first roasted and brewed, in a similar way to how it is now prepared. By the 16th century, it had reached the rest of the Middle East, Persia, Turkey, and northern Africa. Coffee seeds were first exported from Ethiopia to Yemen.")
    test6 = Article(
        user_id=6, title='My Oath', description='http://www.pbs.org/wgbh/nova/body/hippocratic-oath-today.html',article="Hippocratic Oath: Modern Version. I swear to fulfill, to the best of my ability and judgment, this covenant: I will respect the hard-won scientific gains of those physicians in whose steps I walk, and gladly share such knowledge as is mine with those who are to follow.")
    test7 = Article(
